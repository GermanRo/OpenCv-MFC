...
// InterfazMFC.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CInterfazMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CInterfazMFCApp

CInterfazMFCApp::CInterfazMFCApp()
{
...
// Único objeto CInterfazMFCApp

CInterfazMFCApp theApp;


// Inicialización de CInterfazMFCApp

BOOL CInterfazMFCApp::InitInstance()
{
